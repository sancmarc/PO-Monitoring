...
class BivnController extends Controller
{
    public function index()
    {
        return view('admins.bivn');
    }

    public function fetchBivn()
    {
        $billBIVN = DB::Table('billing_monitorings')
            ...
            ->where('pomonitors.model', '=', '2')
            ->get();
            return DataTables::of($billBIVN)
            ->addIndexColumn()
    ...
    public function poBivn()
    {
        return view('admins.bivn-po');
    }
}
