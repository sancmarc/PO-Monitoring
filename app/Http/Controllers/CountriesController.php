...
class CountriesController extends Controller
{
        ...
        return DataTables::of($countries)
                            ...
                            ->addColumn('actions', function($row){
                                return '<div class="btn-group">
                                            <button class="btn btn-sm btn-success" data-id="'.$row['id'].'" id="editCountryBtn">Edit</button>
    ...
    public function deleteCountry(Request $request){
        ...
        if(!$query){
            ...
            return response()->json(['code'=>1,'msg'=>'Country has been deleted']);
        }
    ...
    public function deleteSelectedCountries(Request $request){
        ...
        return response()->json(['code'=>1,'msg'=>'Countries has been deleted']);
    }
}
